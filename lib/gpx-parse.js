...
var assert = require("assert"),
    ...
    GpxWaypointExtensions = require('./gpxWaypointExtensions'),
    ...
    gpxTracks.forEach(function(currentTrack) {
      ...
      currentTrack.trkseg.forEach(function(currentSegment) {
        ...
        currentSegment.trkpt.forEach(function(trackPoint) {
          ...
          var extensions = trackPoint.extensions[0]["gpxtpx:TrackPointExtension"][0];
          var waypointExtensions = new GpxWaypointExtensions(extensions["gpxtpx:hr"][0],extensions["gpxtpx:cad"][0]);          
