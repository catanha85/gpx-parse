 ...
 * @param {<GpxWaypointExtensions>} extensions Garmin Extensions (such as heart rate, cadence, ...) 
 **/
function GpxWaypoint(lat, lon, elevation, time, magvar, geoidheight, name, cmt, desc, src, links, sym, type, extensions) {
	...
	**/
	this.__defineGetter__("time", function() {
		...
		/**
	* Garmin Extensions (such as heart rate, cadence, ...) for the Waypoint
	* @name extensions
	* @memberOf GpxWaypoint
	* @instance
	* @type {GpxWaypointExtensions}
	**/
